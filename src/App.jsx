...
import { CartProvider } from './pages/clients/CartContext';
import { FloatingCart } from './pages/clients/FloatingCart';
...
import DebutPage from './pages/clients/DebutPage';
// ✅ UNIQUEMENT CommandePage (confirmation plus tard)
import CommandePage from './pages/clients/CommandePage';
        ...
        <div className="min-h-screen bg-slate-950">
          <Routes>
            ...
            <Route path="/boutique/:urlBoutique" element={<BoutiqueLayout />}>
              ...
              {/* ✅ SEULEMENT COMMANDE (fonctionne maintenant) */}
